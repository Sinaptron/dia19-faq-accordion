...
<div align="center" style="text-align: center">
 <h1><b>FAQ Accordion<b></h1>  
<p>FAQ Accordion, Este proyecto es parte del desafío #100daysofprojects promovido por:</p> 
...
- Ocultar las demás y mostrar el contenido de la pregunta que se hizo clic.

### _Importante:_
- Agregar icono favicon al proyecto.
- Renombrar URL fácil de recordar (ej. FAQ Accordion).
- Agregar título al proyecto (ej. FAQ Accordion - Frontend Club).
...
`>>>` : [Opcion 01](https://www.frontendmentor.io/challenges/faq-accordion-wyfFdeBwBz)<br>
